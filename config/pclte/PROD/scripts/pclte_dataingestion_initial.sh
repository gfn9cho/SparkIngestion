...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --conf spark.ui.port=8088 --conf spark.executor.memoryOverhead=3g  \
 ...
 --files ${spec_files_path}/pclte_initial.properties#diProperties.properties,${spec_files_path}/pclte_lookup_info.csv#pclte_lookup_info.csv,${spec_files_path}/pclte_pii_spec.csv#pclte_pii_spec.csv,${spec_files_path}/pclte_table_spec.csv#pclte_table_spec.csv,/etc/spark/conf/hive-site.xml \
 --properties-file /usr/lib/spark/conf/spark-defaults.conf \
 ${jar_path}/${spark_app_jar_file_suffix}-${spark_app_jar_file_version} \
PCLTE_TL_DataIngestion  
status=$?
