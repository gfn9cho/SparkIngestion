...
spark-submit --class edf.missingdataload.FindAndLoadMissingRecords \
 ...
 --files ${spec_files_path}/fairScheduler.xml#fairScheduler.xml,${spec_files_path}/gwbc_missing_stg.properties#diProperties.properties,${base_dir}/gwbc/spec_files/gwbc_lookup_info.csv#gwbc_lookup_info.csv,${base_dir}/gwbc/spec_files/gwbc_pii_spec.csv#gwbc_pii_spec.csv,${base_dir}/gwbc/spec_files/gwbc_table_spec_stg.csv#gwbc_table_spec_stg.csv,${spec_files_path}/gwbc_missing_table_list.csv#gwbc_missing_table_list.csv,/etc/spark/conf/hive-site.xml \
