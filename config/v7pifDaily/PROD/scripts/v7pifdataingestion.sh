...
log_file=$base_dir"/logs/"$DATE"/v7pifDataIngestion_"$DATE_TS".log"
spec_files_path=$base_dir/v7pifDaily
...
--master yarn --deploy-mode cluster --conf spark.shuffle.spill=true \
 ...
 --files $spec_files_path/v7pif_daily.properties#diProperties.properties,$spec_files_path/v7pif_LookupAnalysis_daily.csv#v7pif_LookupAnalysis_daily.csv,$spec_files_path/v7pif_PIISpec_daily.csv#v7pif_PIISpec_daily.csv,$spec_files_path/v7pif_TableSpec_daily.csv#v7pif_TableSpec_daily.csv,/etc/spark/conf/hive-site.xml \
