...
log_file=$base_dir"/logs/"$DATE"/v7mpifDataIngestion_"$DATE_TS".log"
...
--master yarn --deploy-mode cluster  --conf spark.shuffle.spill=true \
 ...
 --files $spec_files_path/v7pif.properties#diProperties.properties,$spec_files_path/v7pif_LookupAnalysis.csv#v7pif_LookupAnalysis.csv,$spec_files_path/v7pif_PIISpec.csv#v7pif_PIISpec.csv,$spec_files_path/v7pif_TableSpec.csv#v7pif_TableSpec.csv,/etc/spark/conf/hive-site.xml \
