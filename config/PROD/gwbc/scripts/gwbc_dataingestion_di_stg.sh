...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --name gwbc_DI_stage_dataingestion  \
 --files $spec_files_path/gwbc_DI_stg.properties#diProperties.properties,$spec_files_path/gwbc_lookup_info.csv#gwbc_lookup_info.csv,$spec_files_path/gwbc_pii_spec.csv#gwbc_pii_spec.csv,$spec_files_path/gwbc_table_spec_stg.csv#gwbc_table_spec_stg.csv,/etc/spark/conf/hive-site.xml \
 --properties-file /usr/lib/spark/conf/spark-defaults.conf \
 $ingestion_jar_path/$ingestion_jar_name \
gwbc_DI_stage_dataingestion 1>>$log_file 2>&1
status=$?
