...
echo "Started the script for GWPL CI "
...
log_file=$base_dir"/logs/"$date"/gwplCIdataingestion_"$date_ts".log"
...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --name "gwpl_ci_dataingestion"  \
  --files ${spec_files_path}/gwpl_CI.properties#diProperties.properties,${spec_files_path}/gwpl_lookup_info_CI.csv#gwpl_lookup_info_CI.csv,${spec_files_path}/gwpl_pii_spec_CI.csv#gwpl_pii_spec_CI.csv,${spec_files_path}/gwpl_table_spec_CI.csv#gwpl_table_spec_CI.csv,/etc/spark/conf/hive-site.xml \
