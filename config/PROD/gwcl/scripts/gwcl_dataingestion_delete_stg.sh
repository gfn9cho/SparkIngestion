...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --files $spec_files_path/gwcl_delete_stg.properties#diProperties.properties,$spec_files_path/gwcl_lookup_info.csv#gwcl_lookup_info.csv,$spec_files_path/gwcl_pii_spec.csv#gwcl_pii_spec.csv,$spec_files_path/gwcl_table_spec_stg.csv#gwcl_table_spec_stg.csv,/etc/spark/conf/hive-site.xml \
