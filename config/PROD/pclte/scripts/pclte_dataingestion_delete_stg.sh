...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --files ${spec_files_path}/pclte_delete_stg.properties#diProperties.properties,${spec_files_path}/pclte_lookup_info.csv#pclte_lookup_info.csv,${spec_files_path}/pclte_pii_spec.csv#pclte_pii_spec.csv,${spec_files_path}/pclte_table_spec_stg.csv#pclte_table_spec_stg.csv,/etc/spark/conf/hive-site.xml \
