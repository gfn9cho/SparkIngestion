...
import edf.utilities.{CdcQueryBuilder, JdbcConnectionUtility, MetaInfo, TraversableOnceExt, sqlQueryParserFromCSV}
...
package object dataload {
    ...
    val dbType: String = propertyMap.getOrElse("spark.DataIngestion.dbType","")
