...
echo "Started the script for GWCL TL "
...
log_file=$base_dir"/logs/"$date"/gwclTLIngestion_"$date_ts".log"
...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --name "gwcl_tl_dataingestion"  \
  --files ${spec_files_path}/gwcl.properties#diProperties.properties,${spec_files_path}/gwcl_lookup_info.csv#gwcl_lookup_info.csv,${spec_files_path}/gwcl_pii_spec.csv#gwcl_pii_spec.csv,${spec_files_path}/gwcl_table_spec.csv#gwcl_table_spec.csv,/etc/spark/conf/hive-site.xml \
