...
spark-submit --class edf.missingdataload.FindAndLoadMissingRecords \
 ...
 --name "GWCC_Missing_DataIngestion"  \
   --files ${spec_files_path}/fairScheduler.xml#fairScheduler.xml,${spec_files_path}/gwcc_missing_stg.properties#diProperties.properties,${base_dir}/gwcc/spec_files/gwcc_lookup_info.csv#gwcc_lookup_info.csv,${base_dir}/gwcc/spec_files/gwcc_pii_spec.csv#gwcc_pii_spec.csv,${base_dir}/gwcc/spec_files/gwcc_table_spec_stg.csv#gwcc_table_spec_stg.csv,${spec_files_path}/gwcc_missing_table_list.csv#gwcc_missing_table_list.csv,/etc/spark/conf/hive-site.xml \
