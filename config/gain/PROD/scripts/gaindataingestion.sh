...
log_file=$base_dir"/logs/"$DATE"/gainDataIngestion_"$DATE_TS".log"
spec_files_path=$base_dir/gain
jar_path=$base_dir/jars/
spark_app_jar_file_suffix=edf_dataingestion-assembly
spark_app_jar_file_version=1.1.2.jar
...
--master yarn --deploy-mode cluster --conf spark.shuffle.spill=true \
 ...
 --files $spec_files_path/gain_daily.properties#diProperties.properties,$spec_files_path/gain_LookupAnalysis.csv#gain_LookupAnalysis.csv,$spec_files_path/gain_PIISpec.csv#gain_PIISpec.csv,$spec_files_path/gain_TableSpec.csv#gain_TableSpec.csv,/etc/spark/conf/hive-site.xml \
