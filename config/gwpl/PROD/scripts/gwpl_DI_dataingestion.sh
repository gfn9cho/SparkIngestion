...
echo "Started the script for GWPL DI "
...
log_file=$base_dir"/logs/"$date"/gwplDIdataingestion_"$date_ts".log"
...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --name "gwpl_di_dataingestion"  \
  --files ${spec_files_path}/gwpl_DI.properties#diProperties.properties,${spec_files_path}/gwpl_lookup_info_DI.csv#gwpl_lookup_info_DI.csv,${spec_files_path}/gwpl_pii_spec_DI.csv#gwpl_pii_spec_DI.csv,${spec_files_path}/gwpl_table_spec_DI.csv#gwpl_table_spec_DI.csv,/etc/spark/conf/hive-site.xml \
