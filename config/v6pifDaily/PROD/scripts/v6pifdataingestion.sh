...
log_file=$base_dir"/logs/"$DATE"/v6pifDataIngestion_"$DATE_TS".log"
spec_files_path=$base_dir/v6pifDaily
...
--master yarn --deploy-mode cluster --conf spark.shuffle.spill=true \
 ...
 --files $spec_files_path/v6pif_daily.properties#diProperties.properties,$spec_files_path/v6pif_LookupAnalysis_daily.csv#v6pif_LookupAnalysis_daily.csv,$spec_files_path/v6pif_PIISpec_daily.csv#v6pif_PIISpec_daily.csv,$spec_files_path/v6pif_TableSpec_daily.csv#v6pif_TableSpec_daily.csv,/etc/spark/conf/hive-site.xml \
