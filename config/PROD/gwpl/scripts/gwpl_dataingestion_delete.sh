...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --files $spec_files_path/gwpl_delete.properties#diProperties.properties,$spec_files_path/gwpl_lookup_info.csv#gwpl_lookup_info.csv,$spec_files_path/gwpl_pii_spec.csv#gwpl_pii_spec.csv,$spec_files_path/gwpl_table_spec.csv#gwpl_table_spec.csv,/etc/spark/conf/hive-site.xml \
