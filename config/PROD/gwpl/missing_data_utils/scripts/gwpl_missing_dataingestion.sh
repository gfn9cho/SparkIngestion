...
spark-submit --class edf.missingdataload.FindAndLoadMissingRecords \
 ...
 --files ${spec_files_path}/fairScheduler.xml#fairScheduler.xml,${spec_files_path}/gwpl_missing.properties#diProperties.properties,${base_dir}/gwpl/spec_files/gwpl_lookup_info.csv#gwpl_lookup_info.csv,${base_dir}/gwpl/spec_files/gwpl_pii_spec.csv#gwpl_pii_spec.csv,${base_dir}/gwpl/spec_files/gwpl_table_spec.csv#gwpl_table_spec.csv,${spec_files_path}/gwpl_missing_table_list.csv#gwpl_missing_table_list.csv,/etc/spark/conf/hive-site.xml \
