...
spark-submit --class edf.missingdataload.FindAndLoadMissingRecords \
 ...
 --files ${spec_files_path}/fairScheduler.xml#fairScheduler.xml,${spec_files_path}/gwcl_missing_stg.properties#diProperties.properties,${base_dir}/gwcl/spec_files/gwcl_lookup_info.csv#gwcl_lookup_info.csv,${base_dir}/gwcl/spec_files/gwcl_pii_spec.csv#gwcl_pii_spec.csv,${base_dir}/gwcl/spec_files/gwcl_table_spec_stg.csv#gwcl_table_spec_stg.csv,${spec_files_path}/gwcl_missing_table_list.csv#gwcl_missing_table_list.csv,/etc/spark/conf/hive-site.xml \
