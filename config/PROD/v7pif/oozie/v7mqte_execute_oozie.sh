...
# Description : monthly load dmact,v6pif,v7pif,v7mqte execute oozie workflow #
...
LOGGER I "oozie job --oozie ${oozie_url} -config ${base_dir}/v7pif/oozie/${workflow_name}_job.properties -run"

oozie_jobId=`oozie job --oozie ${oozie_url} -config ${base_dir}/v7pif/oozie/${workflow_name}_job.properties -run`
