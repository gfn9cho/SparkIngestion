...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --name pclte_di_stage_dataingestion  \
 --files ${spec_files_path}/pclte_DI_stg.properties#diProperties.properties,${spec_files_path}/pclte_lookup_info.csv#pclte_lookup_info.csv,${spec_files_path}/pclte_pii_spec.csv#pclte_pii_spec.csv,${spec_files_path}/pclte_table_spec_stg.csv#pclte_table_spec_stg.csv,/etc/spark/conf/hive-site.xml \
 --properties-file /usr/lib/spark/conf/spark-defaults.conf \
 $ingestion_jar_path/$ingestion_jar_name \
pclte_di_stage_dataingestion 1>>$log_file 2>&1
status=$?
