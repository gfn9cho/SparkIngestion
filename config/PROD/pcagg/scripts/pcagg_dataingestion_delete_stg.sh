...
spark-submit --class edf.dataingestion.DataLoad \
 ...
 --files $spec_files_path/pcagg_delete_stg.properties#diProperties.properties,$spec_files_path/pcagg_lookup_info.csv#pcagg_lookup_info.csv,$spec_files_path/pcagg_pii_spec.csv#pcagg_pii_spec.csv,$spec_files_path/pcagg_table_spec_stg.csv#pcagg_table_spec_stg.csv,/etc/spark/conf/hive-site.xml \
